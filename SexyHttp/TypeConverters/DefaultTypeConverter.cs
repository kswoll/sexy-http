...
namespace SexyHttp.TypeConverters
{
    public class DefaultTypeConverter : CombinedTypeConverter
    {
        ...
        public static DefaultTypeConverter Create()
        {
            ...
            var result = new DefaultTypeConverter(new ITypeConverter[] { registry, new IdentityTypeConverter(), new ElementToArrayTypeConverter(), new SystemConvertTypeConverter() });
