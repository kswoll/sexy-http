...
namespace SexyHttp.Tests
{
    ...
    public class HttpApiTests
    {
        ...
        public async void PathWithSubstitution()
        {
            ...
            await endpoint.Call(httpHandler, new MockApiRequestInstrumenter(), "http://localhost", new Dictionary<string, object> { ["key"] = "to" });
        ...
        public async void QueryWithSubstitution()
        {
            ...
            var endpoint = api.Endpoints.Single().Value;
            var httpHandler = new MockHttpHandler();
            await endpoint.Call(httpHandler, new MockApiRequestInstrumenter(), "http://localhost", new Dictionary<string, object> { ["key"] = "bar" });
        ...
        public async void ApiLevelTypeConverter()
        {
            ...
            var endpoint = api.Endpoints.Single().Value;
            var httpHandler = new MockHttpHandler();
            await endpoint.Call(httpHandler, new MockApiRequestInstrumenter(), "http://localhost", new Dictionary<string, object> { ["number"] = 5 });
        ...
        public async Task ComposedJsonBody()
        {
            ...
            var endpoint = api.Endpoints.Single().Value;
            var httpHandler = new MockHttpHandler();
            await endpoint.Call(httpHandler, new MockApiRequestInstrumenter(), "http://localhost", new Dictionary<string, object> { ["value1"] = 5, ["value2"] = "foo" });
        ...
        public async void JsonResponse()
        {
            ...
            var result = (string)await endpoint.Call(httpHandler, new MockApiRequestInstrumenter(), "http://localhost", new Dictionary<string, object>());
